...
export function DeleteAccountDialog() {
  ...
  async function deleteAccount() {
    ...
    if (!response.ok) { setError('Unable to delete your account. Please try again.'); setPending(false); return; }
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>This action cannot be undone. Your Firebase account and user profile will be permanently deleted.</AlertDialogDescription>
        </AlertDialogHeader>
